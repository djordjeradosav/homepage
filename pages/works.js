  ...
  <Layout title="Works">
    <Container>
      ...
      <SimpleGrid columns={[1, 1, 2]} gap={6}>
        <Section>
          <WorkGridItem id="covid" passHref>
        ...
        <Section delay={0.1}>
          <WorkGridItem id="biolink" passHref>
